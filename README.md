...
|-----------|------------------------------|----------|----------|
| 1.1.0     | 1.7.4, 1.8.0, 1.8.1, 1.8.2, 1.8.3, 1.8.4, 1.8.5, 1.8.6, 1.8.7, 1.8.8 | OpenLDAP, MySQL/MariaDB, PostgreSQL | 2026-09-20 |
...
- Expiry date per mailbox (`mailbox.expired`, LDAP `expiredDate`): the last day it works, empty means that it never expires
...
- The SRS exclude domains (`iredapd.srs_exclude_domains`): iRedAPD keeps the original sender address of a forwarded message of these domains instead of rewriting it with SRS
