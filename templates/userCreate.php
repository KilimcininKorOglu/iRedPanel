  ...
  <div class="col-xl-7">
    <form method="post" autocomplete="off" class="card">
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          <label for="passwordHash" class="form-label"><?= $te('user.password_hash') ?></label>
          ...
          <div class="form-text"><?= $te('user.password_hash_hint') ?></div>
        </div>
        ...
        <div class="row g-3<?= !empty($session['isGlobalAdmin']) ? ' mb-3' : '' ?>">
          <div class="col-md-6">
            <label for="mailboxFormat" class="form-label"><?= $te('user.mailbox_format') ?></label>
          ...
          <div class="col-md-6">
            <label for="mailboxFolder" class="form-label"><?= $te('user.mailbox_folder') ?></label>
        ...
        <div>
          <label for="maildir" class="form-label"><?= $te('user.maildir_path') ?></label>
          ...
          <div class="form-text"><?= $te('user.maildir_path_hint') ?></div>
        </div>
        <?php endif; ?>
      </div>
