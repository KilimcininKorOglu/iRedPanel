      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-check form-switch mt-3">
            ...
            <label class="form-check-label" for="alwaysInsertXSpamHeaders"><?= $te('spampolicy.always_insert_x_spam_headers') ?></label><?= $help('spampolicy.always_insert_x_spam_headers') ?>
          </div>
        </div>
      </div>
