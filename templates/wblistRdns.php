  ...
  <div class="row g-3">
    <div class="col-lg-6">
      <div class="card h-100 mb-0">
        <div class="card-header"><i class="bi bi-check-circle text-success me-2"></i><?= $te('wblist.rdns_whitelist_legend') ?><?= $help('wblist.rdns_whitelist_legend') ?></div>
        <div class="card-body">
    ...
    <div class="col-lg-6">
      <div class="card h-100 mb-0">
        <div class="card-header"><i class="bi bi-slash-circle text-danger me-2"></i><?= $te('wblist.rdns_blacklist_legend') ?><?= $help('wblist.rdns_blacklist_legend') ?></div>
        <div class="card-body">
